 ...
 */
package com.myproject.returntosender;

/**
 *
 * @author SHIVALI
 */
public class returntosender {public static void main(String[] args) {
...
public static int secret(){ return 42;}
 public static double surprise(){return 3.14;  }
  public static char mystery(){return 'X';}
     public static boolean classified(){ return true;}    
public static String unexpected(){return "Spanish Inquisition"; }
}
